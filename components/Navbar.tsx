...
export default function Navbar() {
    return (
        <>
            <nav className='h-12 w-full font-light z-10 bg-[#111010] text-white bg-opacity-90 sticky top-0 text-lg mt-4 mx-auto flex text-center justify-center items-center gap-2 md:gap-20'>
