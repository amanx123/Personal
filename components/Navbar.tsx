...
export default function Navbar() {
    return (
        <>
            <nav className='h-12 font-light z-10 bg-[#111010] text-white bg-opacity-95 sticky top-0 text-lg px-2 mt-4 mx-auto flex justify-center items-center gap-2 md:gap-20'>
